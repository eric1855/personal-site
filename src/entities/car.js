...
import { createCarPhysics, GROUND_Y } from '../physics/carPhysics.js'

// Dust constants
const MAX_PARTICLES        = 120
const PARTICLE_LIFETIME    = 35
const EMIT_SPEED_THRESHOLD = 0.5   // adjusted for Rapier speed scale
...
export function createCar(scene, RAPIER, world) {
  ...
  const { carState, preStep: physicsPreStep, postStep: physicsPostStep } = createCarPhysics(RAPIER, world)
